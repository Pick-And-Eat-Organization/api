...
public class CurrentProAccountApiResponse extends GenericApiResponse<CurrentProAccountResponse> {
  public CurrentProAccountApiResponse() {
    super(
        "Account retrieved successfully.",
        new CurrentProAccountResponse(
            1L,
